...
public class MainActivity extends Activity {
  ...
  private static final String STATE_BREADCRUST= "dk.humma.android.permissions.runtime.breadcrust";
  private static final String STATE_IN_PERMISSION= "dk.humma.android.permissions.runtime.inPermission";

  private static final String[] PERMS_ALL={ CAMERA,
  ...
  private static final String[] PERMS_TAKE_PICTURE={ CAMERA,
          WRITE_EXTERNAL_STORAGE
  }; //Permission Array

  private File rootDir; //Root directory
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (isFirstRun() && !isInPermission) { // Check permission on first run
  ...
  public void takePicture(View v) {
    if (canTakePicture()) {
      ...
      breadcrust.setText(R.string.msg_take_picture); breadcrust.setVisibility(View.VISIBLE);
    }
    else {
      breadcrust.setVisibility(View.GONE); ActivityCompat.requestPermissions(this,
  ...
  public void recordVideo(View v) {
    ...
    {
      breadcrust.setText(R.string.msg_record_video); breadcrust.setVisibility(View.VISIBLE);
    } else {
      breadcrust.setVisibility(View.GONE); ActivityCompat.requestPermissions(this,
  ...
  //Check if user can take picture
  ...
  private boolean shouldShowTakePictureRationale() {
    return(ActivityCompat.shouldShowRequestPermissionRationale(
          this, CAMERA) || ActivityCompat.shouldShowRequestPermissionRationale(this,
          WRITE_EXTERNAL_STORAGE));
  }
  ...
  protected void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    if (cs!=null) {
      breadcrust.setVisibility(View.VISIBLE); breadcrust.setText(cs);
    }
  }
}
